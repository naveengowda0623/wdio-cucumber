...
exports.config = {
	...
	before: async function before() {
		...
		/**
		 * Reading CSV file and assigning to global variable
		 */
		const csvFilePath = `${testSourePath}src/testdata/${dataSheet}.csv`
		global.masterTestData = await csv().fromFile(csvFilePath)
	},
	//
